...
import { Check, Play, Hourglass, MoreVertical, Plus } from 'lucide-react-native';

type SetStatus = 'idle' | 'working' | 'completed';

export const SetRow = memo(({ set, index, onUpdate, onInteraction, onRemove }: any) => {
        ...
        <View className="gap-2 p-3">
          <View className="mb-1 flex-row items-center px-1">
            ...
            <View className="flex-1 items-center">
              <Text className="text-[10px] font-bold text-muted-foreground">KG</Text>
            </View>
            <View className="flex-1 items-center">
